...
# ==========================================
label act1:
    scene escena1 with fade
    play music "lofi_rain.mp3" fadein 1.0

    n "La laptop abierta. El documento casi en blanco. El correo del profesor dice: 'Avance obligatorio para el viernes'."
...
label act2_court:
    ...
    scene cancaha_de_baloncesto11 with fade
    menu:
...
label path_accident:
    scene accidente
    play music "Lil Peep - Life Is Beautiful.ogg" fadein 1.0
...
label path_overdose:
    scene finalalcochol
    play music "brvhrtz-heartbeat-01-brvhrtz-225058.mp3" fadein 1.0
